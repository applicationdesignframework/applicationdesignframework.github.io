...
* Define technical flows (e.g., load balancer &#8594; API &#8594; database; not ELB &#8594; AWS Lambda + Python &#8594; Amazon RDS) based on business flows. 
